...
const OrganizationDashboard = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen gap-14">
      ...
      <button className="w-full max-w-xl py-10 px-10 bg-rose hover:bg-pink-500 uppercase text-white rounded-lg shadow-md text-3xl font-bold font-sans md:text-4xl md:py-14 md:px-14 flex items-center justify-center gap-4">
        Delete User
        <svg
          xmlns="http://www.w3.org/2000/svg"
          height="48px"
