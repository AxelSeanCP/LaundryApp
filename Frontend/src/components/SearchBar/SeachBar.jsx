...
const SearchBar = ({ placeholderText, inputValue, onInputChange }) => {
  return (
    <div className="flex items-center space-x-2 w-full px-2 max-w-md">
      ...
      <input
        ...
        className="w-full px-3 py-2 mt-1 border-b-2 rounded-md border-slate-600 focus:outline-none italic"
      />
    </div>
  );
};
